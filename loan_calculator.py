...
class LoanCalculator:
    def __init__(self):
        ...
        btComputePayment=Button(window,text='Compute Payment',bg='red',fg='red',font='Helvetica 14 bold', command=self.computePayment).grid(row=6,column=2,sticky=E)
        btClear=Button(window,text='Clear',bg='blue',fg='blue',font='Helvetica 14 bold',command=self.delete_all).grid(row=6,column=8,padx=20,pady=20,sticky=E)
